...
(function() {
    ...
    launch(everyTime) {
      ...
      setInterval(() => {
        const options = {
          ...
          life: this.getRandom(300, 100),
          beamSize: this.getRandom(600, 400),
          velocity: this.getRandom(6, 3)
        };
  ...
  class Starfield {
    constructor(canvasId) {
      ...
      this.stars = []; // Array to store star properties
      this.starsNum = 150; // Number of stars
      this.resizeCanvas();
      window.addEventListener('resize', () => this.resizeCanvas());
      this.animateStars(); // Start the animation loop
    }
    ...
    drawStars() {
      ...
      this.stars.forEach((star) => {
        ...
        if (star.opacity >= 1 || star.opacity <= 0) {
          star.twinkleSpeed = -star.twinkleSpeed; // Reverse direction
        }
      });
    }
    ...
    animateStars() {
      this.drawStars();
      requestAnimationFrame(() => this.animateStars()); // Loop the animation
    }
  }
